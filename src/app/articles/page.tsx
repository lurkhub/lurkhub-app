...
export default function ArticlesPage() {
    ...
    const handleAddNew = () => router.push("/articles/add");
    const handleArchive = () => router.push("/articles/archives"); // Optional if you want archive button

    const uniqueTags = extractUniqueTags(articles);

    if (loading) {
        return <LoadingMessage text="Loading articles..." />
    }
